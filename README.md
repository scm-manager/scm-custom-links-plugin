...
Customize SCM-Manager with own links

## Usage

Find out how this plugin works on the [plugin documentation page](https://www.scm-manager.org/plugins/scm-custom-links-plugin/docs/).
